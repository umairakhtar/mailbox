<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="TrashForm.aspx.cs" Inherits="WebApplication1.TrashForm" %>
...
<asp:Content ContentPlaceHolderID="head" runat="server" ID="C1"></asp:Content>
    ...
    <Columns>
        ...
        <asp:TemplateField>
            <ItemTemplate>
                <asp:LinkButton ID="lnkDetails" runat="server" Text="Open Message" PostBackUrl='<%# "~/Trashmsg.aspx?RowIndex=" + Container.DataItemIndex %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
