...
{
    public partial class TrashForm : System.Web.UI.Page
    {
        ...
        public void bindGrid()
        {
            ...
            if (a == 1)
            {
                ...
                query = "select FromUser, MessageSubject, InboxMessage, Intime from " + Constants.d2.INBOXTBL+" where TrashFlag=1";
